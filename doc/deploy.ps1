...
Write-Host "     powershell -ExecutionPolicy Bypass -File `"$SKILL_DIR\analyze.ps1`" -Source `"https://github.com/browser-use/browser-use`""
Write-Host ""
Write-Host "  2. Analyze your local code:"
Write-Host "     powershell -ExecutionPolicy Bypass -File `"$SKILL_DIR\analyze.ps1`" -Source `"C:\Projects\my-project`""
Write-Host ""
Write-Host "  3. Analyze all your OpenClaw skills:"
Write-Host "     powershell -ExecutionPolicy Bypass -File `"$SKILL_DIR\analyze.ps1`" -Source `"skill:*`""
Write-Host ""
Write-Host "  4. Discover trending repos:"
Write-Host "     powershell -ExecutionPolicy Bypass -File `"$SKILL_DIR\discover.ps1`""
Write-Host ""
Write-Host "  5. Search your knowledge base:"
Write-Host "     powershell -ExecutionPolicy Bypass -File `"$SKILL_DIR\search.ps1`" -Query `"agent async pattern`""
Write-Host ""
Write-Host "  6. Run full daily pipeline:"
Write-Host "     powershell -ExecutionPolicy Bypass -File `"$SKILL_DIR\daily-pipeline.ps1`""
Write-Host ""
